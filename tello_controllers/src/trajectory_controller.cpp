#include "tello_controllers/TelloTrajectoryController.hpp"
...
bool TrajectoryController::initialize(){
    ...
    // Crazyflie Pose Ref
    ref_pose_ = this->create_publisher<geometry_msgs::msg::Pose>("dron01/goal_pose", 10);
    // Crazyflie Pose
    GT_pose_ = this->create_subscription<geometry_msgs::msg::Pose>("dron01/cf_pose", 10, std::bind(&TrajectoryController::gtposeCallback, this, _1));
